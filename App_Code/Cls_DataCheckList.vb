...
Public Class Cls_DataCheckList

    Private Function GetConnectionString() As String
        Dim strConn As String
        strConn = Configuration.WebConfigurationManager.ConnectionStrings("POS105CheckListConnectionString").ConnectionString.ToString
        Return strConn
    End Function
