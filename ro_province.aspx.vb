...
Partial Class ro_province
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        hide_this_edit.Value() = "PROVINCE_MANAGER"
        hide_this_edit_by.Value() = "EMP_INFO_ADMIN"
        ...
        If Session("Uemail") IsNot Nothing Then
            ...
            If CP.rCheckPermit(hide_this_edit_by.Value) > 0 Then
    ...
    Sub loadData()
        ...
        Dim vSql As String = "select authen_id, emp_id, uemail, ro, cluster, province, pvzone, "
        ...
        If vRes.Rows().Count() > 0 Then
            For i As Integer = 0 To vRes.Rows().Count() - 1
                ...
                ' vTable += "<td>" + vRes.Rows(i).Item("pvzone") + "</td>"
