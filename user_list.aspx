...
<head runat="server">
	...
	<title>User List [3BB Shop Back Office]</title>
...
<body>	
    ...
    <nav class="navbar navbar-default">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="user_list.aspx">Back Office Editor</a></li>
                <li><a href="admin_list.aspx">Back Office Admin</a></li>
            </ul>
        </div>
    </nav>

	<div class="container">
		<p class="lead" style="color: #004181;">รายชื่อผู้มีสิทธิ์แก้ไขข้อมูล 3BB Shop</p>
		...
		<button runat="server" id="btn_new" type="button" class="btn btn-default" onclick="newUser()" style="display: none;">
			<span class="glyphicon glyphicon-plus"></span> เพิ่ม User ใหม่
		</button>
	...
	<div id="modal_permiss_confirm" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-nm">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">มี User นี้ ในรายชื่อผู้มีสิทธิ์แก้ไขข้อมูล 3BB Shop แล้ว</h4>
				</div>
				<div class="modal-body">
