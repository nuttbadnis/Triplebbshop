	...
	<div class="container container-table">
        <div class="col-xs-12 box-container" style="padding: 20px;">
            <div class="panel panel-default">
                <div class="panel-heading"><b>API GET POINT (redis)</b></div>
...
function redisGetPoint(){
    ...
    var url = "ajax_chart.aspx?qrs=redisGetPoint&acc=" + acc;
    console.log("redisGetPoint = " + url);
    ...
    $.ajax({
        ...
        success: function(data) { 
            ...
            if (Object.keys(json_customerPoint).length > 0) {
                ...
                // document.getElementById("pre_json").innerHTML = JSON.stringify(json_customerPoint, undefined, 4); 
                // document.getElementById("pre_json").innerHTML = JSON.stringify(data, undefined, 4); 

            }
            else {
                // document.getElementById("pre_json").innerHTML = "ไม่พบผลลัพธ์ [" + acc + "]";
            }
                document.getElementById("pre_json").innerHTML = JSON.stringify(data, undefined, 4); 
