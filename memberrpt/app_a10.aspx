...
function htmlTableT10(data) {
    ...
    "<br>* จำนวนลูกค้าของแต่ละ Cluster ใช้ จำนวนลูกค้า ณ. สิ้นวันที่ 31 พ.ย. 2563" + 
...
function htmlTableT30(data){
    ...
    pfoot += "<br><br>" +
    "<a class='inonly btn btn-sm btn-default' href='app_download.aspx' title='Export excel'><span class='glyphicon glyphicon-save-file'></span> Download รายละเอียดเพิ่มเติม ได้ที่ L25</a>";
