...
Partial Class app_xport_newcust_type_team
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("cluster") <> Nothing Then
            ...
            vSql += "EXEC dbo.SP_EXPORT_L25_NEWCUST_TYPETEAM '" & xCluster & "', @d1, @d2"
    ...
    Private Sub ExportData()
        ...
        Dim vSaveName As String = "MEMBERRPT_L25_NEWCUST_TYPETEAM_[" + xCluster + "]"
