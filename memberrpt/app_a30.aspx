        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="full-bar active"><a href="app_a30.aspx">A30 ข้อมูลการใช้ Point</a></li>
                    ...
                    <li class="mini-bar active"><a href="app_a30.aspx">A30 ข้อมูลการใช้ Point</a></li>
...
var colorSet_r24 = ['#4796ff', '#F15723', '#8dc900', '#a0a0a0'];
...
var colorSet_inout = ['#4796ff', '#bf3d1c', '#FD8C16', '#8dc900'];
</script>
...
function load_r10023() {
    ...
    var url = "ajax_chart.aspx?qrs=SP_R_NUM&spnum=10025";
    console.log("load_10025 = " + url);
    ...
    $.ajax({
        ...
        success: function(data) { 
            ...
            var accam_used_real_pt = 0;

            $.each(data,function( i,item ) {
                accam_add_pt += parseInt(item.R10023_sum_pt);
                accam_used_pt += parseInt(item.R10022_sum_pt)+parseInt(item.R10025_sum_pt);
                accam_used_real_pt += parseInt(item.R10025_sum_pt);
                accam_redeem_pt += parseInt(item.R10022_sum_pt)

                data_R10023_acc_pt.push(accam_add_pt);
                data_R10025_acc_pt.push(accam_used_pt);
                data_R10022_acc_pt.push(accam_redeem_pt);
                
                //---------------------------------------------------------
                var parcal_all = (accam_add_pt - accam_used_pt) + accam_used_real_pt + accam_redeem_pt;
                
                var percal_add_pt = accam_add_pt - accam_used_pt
                percal_add_pt = calPercent(percal_add_pt, parcal_all);
                percal_add_pt = parseFloat(fixDecimal(2, percal_add_pt));

                var percal_used_pt = calPercent(accam_used_real_pt, parcal_all);
                percal_used_pt = parseFloat(fixDecimal(2, percal_used_pt));

                var percal_redeem_pt = calPercent(accam_redeem_pt, parcal_all);
                percal_redeem_pt = parseFloat(fixDecimal(2, percal_redeem_pt));

                data_R10023_per_pt.push(percal_add_pt);
                data_R10025_per_pt.push(percal_used_pt);
                data_R10022_per_pt.push(percal_redeem_pt);    

                console.log("parcal_all : "+parcal_all);
                console.log("percal_add_pt : "+percal_add_pt);
                console.log("percal_used_pt : "+percal_used_pt);
                console.log("percal_redeem_pt : "+percal_redeem_pt);
            ...
            Highcharts.chart("rd_r10023", {
                ...
                series: [
                 {
                    ...
                    //name: 'จำนวน Point ที่รับสะสม ( R10023 )',
                ...
                , { 
                    ...
                    //name: 'จำนวน Point ที่ ถูกใช้ไป ( R10025 + R10022)',
                    name: 'จำนวน Point ที่ ถูกใช้ไป',
                    data: data_R10025_acc_pt,
                    pointStart: setPointStart(start_data_r10023),
                    pointInterval: setDaysInterval(1),
                }                
                , {
                    ...
                    //name: 'จำนวน Point ที่ลูกค้า Redeem (R10022)',
                    name: 'จำนวน Point ที่ลูกค้า Redeem',
            ...
            Highcharts.chart("rd_r10023_per", {
                ...
                series: [
                {
                    ...
                    //name: 'เปอร์เซ็น Point ที่ยังไม่ถูกใช้ (R10023-(R10022+R10025))',
                ...
                , {
                    ...
                    //name: 'เปอร์เซ็น Point ที่ถูกใช้แล้ว (R10025)',
                    name: 'เปอร์เซ็น Point ที่ Adjust',
                    data: data_R10025_per_pt,
                    pointStart: setPointStart(start_data_r10023),
                    pointInterval: setDaysInterval(1),
                }
                , {
                    ...
                    //name: 'เปอร์เซ็น Point ที่ถูกใช้สะสมรายวัน (R10022)',
                    name: 'เปอร์เซ็น Point ที่ Redeem',
...
function load_r10024() {
    var url = "ajax_chart.aspx?qrs=SP_R_NUM&spnum=10024";
    console.log("load_10024 = " + url);
    ...
    $.ajax({
        ...
        success: function(data) { 
            ...
            var data_date = "";
            var data_r10024_day_count = [];
            var data_r10024_average_7 = [];
            var data_r10024_average_30 = [];
            var data_r10024_last_year = [];
            ...
            $.each(data,function( i,item ) {
                data_r10024_day_count.push(parseInt(item.day_count));
                data_r10024_average_7.push(parseInt(item.average_7));
                data_r10024_average_30.push(parseInt(item.average_30));
                data_r10024_last_year.push(parseInt(item.last_year));
            });
            console.log(data_r10024_day_count);

            Highcharts.chart("rd_r10024", {
                colors: colorSet_r24,
                chart: {
                    type: 'line',
                    style: {
                ...
                title: {
                    text: "กราฟ แสดงสถิติการใช้ Point เฉลี่ยรายชั่วโมง เทียบกับ ข้อมูลประจำวันที่ " + data_date,
                    style: {
                        fontSize: '14px',
                    }
                },
