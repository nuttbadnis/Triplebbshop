<%@ Page Language="VB" AutoEventWireup="false" CodeFile="x20.aspx.vb" Inherits="x20" %>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="full-bar active"><a href="x20.aspx">X20 RECONCILE 3BBPOINT vs VAS</a></li>
                    <li class="full-bar"><a href="x30.aspx">X30 RECONCILE COIN vs VAS</a></li>     

                    <li class="mini-bar"><a href="x10.aspx">X10</a></li>
                    <li class="mini-bar active"><a href="x20.aspx">X20</a></li>
                    <li class="mini-bar"><a href="x30.aspx">X30</a></li>
                </ul>
            </div>
        </div>
    </nav>
	<div class="container container-table">
        <p class="txt-red">
            <b class="b-title">RECONCILE 3BBPOINT VS VAS</b> 
...
function getMaxDateReconcile() {
    var url = "ajax_chart.aspx?qrs=sp_report_reconcile_time"
...
function loadTableReconcile(){
    var url = "ajax_chart.aspx?qrs=sp_report_reconcile_error";
    ...
    $.ajax({
        ...
        success: function(data) { 
            if(data.length > 0) {
                ...
                "<thead>" +
                "<tr>" +
                "<th class='coin-head' colspan='15'>POINT SYSTEM</th>   " +
                "</tr>   " +
                "<tr>" +
                "<th class='rec text-uppercase' colspan='5'>reconcile</th>   " +
                "<th class='bcs text-uppercase' colspan='5'>vas</th>   " +
                "<th class='point text-uppercase' colspan='5'>point system</th>   " +
                "</tr>   " +
                "<tr>    " +
                ...
                "<th class='point'>ref_id</th> " +
                "<th class='point'>date_record</th> " +
                "<th class='point'>account_num</th> " +
                "<th class='point'>item_code</th> " +
                "<th class='point'>item_point</th> " +
                "</tr>" +
                "</thead>" +
                "<tbody>";
...
$('#btn_stop_alert').click(function() {
    var url = "ajax_chart.aspx?qrs=sp_update_reconcile_error";
