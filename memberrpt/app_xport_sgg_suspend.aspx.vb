...
Partial Class app_xport_sgg_suspend
    ...
    Private Sub ExportData()
        ' If Request.QueryString("cluster") <> Nothing Then
            ...
            Dim vSql As String 
            vSql += "EXEC TBB_App_Report_v2002.dbo.SP_EXPORT_L50_SUGGEST_SUSPEND "

            Dim vSaveName As String = "MEMBERRPT_L50_FEB2020_SUGGEST_SUSPEND"
