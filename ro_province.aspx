<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ro_province.aspx.vb" Inherits="ro_province" %>
...
<body>	
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="ro_province.aspx">รายชื่อผู้อำนวยการ/ผู้จัดการ</a></li>
    ...
    <nav class="navbar navbar-default">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="ro_province.aspx">Province Manager</a></li>
                <li><a href="ro_cluster.aspx">Cluster Manager</a></li>
                <li><a href="ro_director.aspx">RO Director</a></li>
            </ul>
        </div>
    </nav>

	<div class="container">
		<p class="lead" style="color: #004181;">รายชื่อผู้จัดการจังหวัด 3BB</p>
		<p class="txt-red" style="font-size:14px;">*แจ้งปรับปรุงข้อมูล ผู้จัดการจังหวัด, Cluster และผู้อำนวยการภาค ได้ที่ <a href="mailto:waraporn.kaw@jasmine.com">waraporn.kaw@jasmine.com</a> คุณ วราภรณ์ แก้วคำหาญ (Marketing)</p>

		<button runat="server" id="btn_new" type="button" class="btn btn-default" onclick="newUser()" style="display: none;">
			<span class="glyphicon glyphicon-plus"></span> เพิ่ม ผู้จัดการจังหวัด
		</button>
	...
	<div id="modal_permiss_confirm" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-nm">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">มี User นี้ ในรายชื่อผู้จัดการจังหวัดแล้ว</h4>
				</div>
				<div class="modal-body">
					<input id="hide_confirm_new_uemail" type="hidden">
					<input id="hide_confirm_new_id" type="hidden">
					<p id="txt_permiss">ข้อความ</p>
				</div>
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-danger" id="btn_permiss_confirm">ยืนยัน</button>
					<button type="button" data-dismiss="modal" class="btn">ยกเลิก</button>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
