...
Partial Class xportExcel_test
    ...
    Private Sub ExportMM()
        ...
        Dim vSql As String = "select vw106.area10 RO, openshop_history.shop_code รหัสสาขา, shopStock.shop_name ชื่อสาขา, "
        ...
        vSql += "shop_close ปิดทำการ, close_time บันทึกปิด, "
        ...
        vSql += "left join [10.11.5.106].rmsdat01.dbo.V_ShopAreaCluster vw106 "
        vSql += "on vw106.shopcode = shopStock.shop_code "
        ...
        vSql += "order by history_date,vw106.area10,openshop_history.shop_code "
