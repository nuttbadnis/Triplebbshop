<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ro_cluster.aspx.vb" Inherits="ro_cluster" %>
...
<body>	
    ...
    <nav class="navbar navbar-default">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="ro_cluster.aspx">Cluster Manager</a></li>
	...
	<div class="container">
		<p class="lead" style="color: #004181;">รายชื่อผู้จัดการ Cluster 3BB</p>
		...
		<button runat="server" id="btn_new" type="button" class="btn btn-default" onclick="newUser()" style="display: none;">
			<span class="glyphicon glyphicon-plus"></span> เพิ่ม ผู้จัดการ Cluster
		</button>
	...
	<div id="modal_permiss_confirm" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-nm">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">มี User นี้ ในรายชื่อผู้จัดการ Cluster แล้ว</h4>
				</div>
				<div class="modal-body">
