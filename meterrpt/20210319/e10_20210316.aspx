...
<body>
    ...
    <div class="container container-table">
                            ...
                            <div class="col-xs-4"> 
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control txt-input-per enter-key" id="txt_lastavg3" placeholder="0" min="-100" max="100" value="20">
                                        <div class="input-group-addon txt-bold">%</div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
            <h5 class="txt-mea" style="line-height: 20px;">
                <!-- <b>คำอธิบาย</b> -->
                <!-- <br> -->
        ...
        <div id='display_table'>
        	<table id='onthetable' class='table table-striped table-bordered nowrap' cellspacing='0' width='100%'>
                ...
                <th rowspan='2'>ประเภทใบเสร็จ</th> 
                <th colspan='6'>UNIT</th> 
                <th colspan='6'>AMOUNT</th> 
                <th colspan='3' style='text-align:center;' class='txt-blue'>บันทึกหมายเหตุ</th>
              </tr>
              <tr>
                <th>MAX</th> 
                <th>MIN</th> 
...
function countE10Filter(){
    urlM30();
    var count_url = "ajax_data.aspx?qrs=count_E10_FILTER" + main_url;
...
function loadE10Filter(){
    ...
    var url = "ajax_data.aspx?qrs=load_E10_FILTER" + main_url;
