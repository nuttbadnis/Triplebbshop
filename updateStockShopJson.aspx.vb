    ...
    Protected Sub followSubmit(ByVal vFollow_id As String, ByVal vFollow_Status As Integer)
        ...
        If vDT.Rows().Count() > 0 Then
            ...
            Try
                ...
                If vExecute >= 1 And vApprove_status <> 8 And vApprove_status <> 9 Then
                    CP.SendMailAdmin(vDT.Rows(0).Item("prove_topic"), vDT.Rows(0).Item("shop_code"))
                End If

                If vExecute >= 1 Then
                    Response.Write("success || " & vFollow_id)
                Else
                    Response.Write("failed || <br><br>" & vSqlIn)

                End If

            Catch ex As Exception
                Response.Write("followSubmit Catching")
            End Try
        End If
    End Sub
