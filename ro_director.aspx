<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ro_director.aspx.vb" Inherits="ro_director" %>
...
<body>	
    ...
    <nav class="navbar navbar-default">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="ro_province.aspx">Province Manager</a></li>
                <li><a href="ro_cluster.aspx">Cluster Manager</a></li>
                <li class="active"><a href="ro_director.aspx">RO Director</a></li>
            </ul>
        </div>
    </nav>

	<div class="container">
		<p class="lead" style="color: #004181;">รายชื่อผู้อำนวยการภาค 3BB</p>
		...
		<button runat="server" id="btn_new" type="button" class="btn btn-default" onclick="newUser()" style="display: none;">
			<span class="glyphicon glyphicon-plus"></span> เพิ่ม ผู้อำนวยการ
		</button>
	...
	<div id="modal_permiss_confirm" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-nm">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">มี User นี้ ในรายชื่อผู้อำนวยการภาคแล้ว</h4>
				</div>
				<div class="modal-body">
